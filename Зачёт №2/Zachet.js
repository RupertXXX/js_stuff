var tel_men = document.getElementById('tel_men');
var up = document.getElementById('up_1_navig');

tel_men.addEventListener("click", function(evt){
	up.classList.add("show_win");
});

up.addEventListener("click", function(cls1){
	up.classList.remove("show_win");
});
...
let btn_win_close = document.getElementById('btn_win_close');
let btn_win_send = document.getElementById('btn_win_send');
